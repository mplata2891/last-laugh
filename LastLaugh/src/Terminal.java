...
public class Terminal extends Item{
	...
	//method to get the value of the activeStatus field
	public boolean getActiveStatus() {
		
		//returns the value of the activeStatus field
		return this.activeStatus;
	}//end getActiveStatus
	
	
	
	//method to set the value of the activeStatus field
	public void setActiveStatus(boolean newBool) {
		
		//assigns the value of newBool to the activeStatus field
		this.activeStatus = newBool;
	}//end setActiveStatus
